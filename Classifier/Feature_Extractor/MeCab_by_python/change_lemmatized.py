...
parser.add_argument('-o', '--output', type=str, default="lemmatized2.txt", help="出力ファイルへのPath(Default:out.txt)")
...
# MeCabのインスタンス作成
mecab = MeCab.Tagger('Ochasen -d /opt/homebrew/lib/mecab/dic/ipadic/')
